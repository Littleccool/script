...
$myDAUFile = sprintf(">%s/data/rmbuserpay/rmbuserpay_new_%s.log",$monitor_path,$Date);
...
$myShopFile = sprintf(">%s/data/rmbuserpay/rmbshopitem_new_%s.log",$monitor_path,$Date);
