...
$sql = sprintf("select uid,register_time,register_platform,substring(from_unixtime(register_time),12,2) from user where substring(from_unixtime(register_time),1,10)>='2012-01-17'");
#print $sql . "\n";
